...
export class Vec4{
  ...
  public static readonly ONE=new Vec4(0,0,0,0);
    ...
    public toArrayBuffer(){ return [this.x,this.y,this.z,this.w] }
}
...
export class Vec3 extends Vec4{
    ...
    public override toArrayBuffer(){ return [this.x,this.y,this.z] }
...
export class Vec2 extends Vec4{
    ...
    public override toArrayBuffer(){ return [this.x,this.y] }
