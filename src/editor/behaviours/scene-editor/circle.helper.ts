...
export class CircleHelper {
    ...
    public draw(shader: Shader, pointSize: number = 1.0, asPoints: boolean = false) {
        ...
        if (asPoints) {
            ...
            this._gl.drawElements(this._gl.POINTS, this.indexCount, this._gl.UNSIGNED_SHORT, 0);
        } else {
            this._gl.drawElements(this._gl.LINE_LOOP, this.indexCount, this._gl.UNSIGNED_SHORT, 0);
        }
