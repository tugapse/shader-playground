...
export class BoundingBoxGizmo {
  ...
  drawBoundingBox(boundingBox: BoundingBox, spacing = 0.1) {
    ...
    const bottomLeftFar = new Vector3(
      min_x - spacing,
      min_y - spacing,
      min_z - spacing,
    );
    const bottomLeftNear = new Vector3(
      min_x - spacing,
      min_y - spacing,
      max_z + spacing,
    );
    ...
    const topRightFar = new Vector3(
      max_x + spacing,
      max_y + spacing,
      min_z - spacing,
    );
    const topRightNear = new Vector3(
      max_x + spacing,
      max_y + spacing,
      max_z + spacing,
    );
    const bottomRightFar = new Vector3(
      max_x + spacing,
      min_y - spacing,
      min_z - spacing,
    );
